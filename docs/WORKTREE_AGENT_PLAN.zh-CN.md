...
| W6 | `qwen35-08b-model` | 0.8B text harness、custom op/model wrapper | AVX-512 基线；前端过渡决策 | 按后端顺序 | M1I decoder 与 M1J typed buffer/mmap binding 已完成；下一步 backend ingestion 与获授权后的 BF16 整网，再做 W8A8-linear |
