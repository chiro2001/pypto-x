...
| W5 | `hip` | AMDGPU LLVM；后续 HIP runtime | `gpu-common`、`cuda` | GamePC `amd-igpu-gfx1036`；当前 WSL `BLOCKED_DEVICE` | 静态 C3 已完成4,532/4,532 Qwen ops；待 `/dev/kfd` 与 ROCm/HIP 可用后做真机执行 |
