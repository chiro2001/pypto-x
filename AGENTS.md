...
- 当前状态是 `EXECUTION_W6_QWEN35_08B_M1D_SVE256_COMPOSITES_IN_PROGRESS`。
- Qwen3.5-0.8B M0、M1A、M1B、M1C1 SVE256 数值原语及 M1C2a/M1C2b layout/indexing 已完成并冻结；当前用既有 primitive 组合 RMSNorm/SwiGLU/Softmax/RoPE/GQA/mask。
