...
> **勘误（2026-09-10）**：本节中出现的 `4,532`、`4,532/4,532`、`6,710` 等计数属于 graph contract v2；
> v3（GDR decay 门修复后）为 `4,550`（(1,1,4096)）/ `6,728`（(1,5,0)）。详见 `docs/00-handoffs/ERRATA.zh-CN.md` ERR-0001。
